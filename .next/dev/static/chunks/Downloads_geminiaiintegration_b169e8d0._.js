...
"[project]/Downloads/geminiaiintegration/app/admin/audit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuditLogsPage() {
    _s();
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$lib$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    const [auditLogs, setAuditLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [stats, setStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        totalEvents: 0,
        activeUsers: 0,
        reportsCreated: 0,
        attendanceEvents: 0
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuditLogsPage.useEffect": ()=>{
            const loadAuditLogs = {
                "AuditLogsPage.useEffect.loadAuditLogs": ()=>{
                    const reports = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$lib$2f$utils$2f$reports$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportsFromStorage"])();
                    const logs = [];
                    ...
                    // Load report events
                    reports.forEach({
                        "AuditLogsPage.useEffect.loadAuditLogs": (report)=>{
                            ...
                            if (report.timeline) {
                                report.timeline.forEach({
                                    "AuditLogsPage.useEffect.loadAuditLogs": (entry)=>{
                                        logs.push({
                    ...
                    logs.sort({
                        "AuditLogsPage.useEffect.loadAuditLogs": (a, b)=>new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime()
                    }["AuditLogsPage.useEffect.loadAuditLogs"]);
                    setAuditLogs(logs);
                    const attendanceEvents = logs.filter({
                        "AuditLogsPage.useEffect.loadAuditLogs": (l)=>l.action === "WORKER_CHECK_IN" || l.action === "WORKER_CHECK_OUT"
                    }["AuditLogsPage.useEffect.loadAuditLogs"]).length;
                    setStats({
                        totalEvents: logs.length,
                        activeUsers: new Set(logs.map({
                            "AuditLogsPage.useEffect.loadAuditLogs": (l)=>l.actor
                        }["AuditLogsPage.useEffect.loadAuditLogs"])).size,
            ...
            const handleAttendanceUpdate = {
                "AuditLogsPage.useEffect.handleAttendanceUpdate": ()=>{
                    console.log("[v0] Attendance updated, reloading audit logs");
                    loadAuditLogs();
                }
            }["AuditLogsPage.useEffect.handleAttendanceUpdate"];
            const handleReportsUpdate = {
                "AuditLogsPage.useEffect.handleReportsUpdate": ()=>{
                    console.log("[v0] Reports updated, reloading audit logs");
                    loadAuditLogs();
                }
            }["AuditLogsPage.useEffect.handleReportsUpdate"];
            const handleAuditLogUpdate = {
                "AuditLogsPage.useEffect.handleAuditLogUpdate": ()=>{
    ...
    const typeColors = {
        success: {
            ...
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Shield$3e$__["Shield"]
        },
        info: {
            bg: "bg-blue-500/10 text-blue-700",
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$activity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Activity$3e$__["Activity"]
        },
        warning: {
    ...
    const getActionIcon = (action)=>{
        if (action.includes("CHECK_IN")) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserCheck$3e$__["UserCheck"];
        if (action.includes("CHECK_OUT")) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$x$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserX$3e$__["UserX"];
        if (action.includes("REPORT")) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$text$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileText$3e$__["FileText"];
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$activity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Activity$3e$__["Activity"];
    };
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            children: auditLogs.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-4",
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionIcon, {
                                                                        className: "h-4 w-4"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/Downloads/geminiaiintegration/app/admin/audit/page.tsx",
                                                                        lineNumber: 231,
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                    ...
                                                                                    children: [
                                                                                        log.details.duration_minutes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    children: [
                                                                                        ...
                                                                                        log.ip_address && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                            className: "text-xs text-muted-foreground",
                                                                                            children: [
                                                                                                "IP: ",
                                                                                                log.ip_address
...
_s(AuditLogsPage, "C9xbUAfRSUOld30KQHee6xjSnIc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$lib$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
...
//# sourceMappingURL=Downloads_geminiaiintegration_b169e8d0._.js.map