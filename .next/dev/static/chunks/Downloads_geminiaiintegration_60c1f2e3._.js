...
"[project]/Downloads/geminiaiintegration/app/citizen/notifications/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotificationsPage() {
    ...
    const profile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$lib$2f$utils$2f$profile$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProfileFromStorage"])() || (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$lib$2f$utils$2f$profile$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeDefaultProfile"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$geminiaiintegration$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationsPage.useEffect": ()=>{
            ...
            const notifs = [];
            reports.forEach({
                "NotificationsPage.useEffect": (report)=>{
                    if (report.timeline && report.timeline.length > 1) {
                        // Create notification for each status change
                        report.timeline.slice(0, 5).forEach({
                            "NotificationsPage.useEffect": (entry)=>{
...
_s(NotificationsPage, "6gMUc0OfbF4zJu51/S5RmKCczuA=");
...
//# sourceMappingURL=Downloads_geminiaiintegration_60c1f2e3._.js.map